...
datax = []
data1=[]
with open('ZDT1 NSGA2 Convergence GM.txt', 'rb') as f:
    my_list1 = pickle.load(f)
data1.append(my_list1)
with open('ZDT1 SPEA2 Convergence GM.txt', 'rb') as f:
    my_list2 = pickle.load(f)
data1.append(my_list2)
with open('ZDT1 SMS2 Convergence GM.txt', 'rb') as f:
...
datax = []
data2=[]
with open('ZDT2 NSGA2 Convergence GM.txt', 'rb') as f:
    my_list1 = pickle.load(f)
data2.append(my_list1)
with open('ZDT2 SPEA2 Convergence GM.txt', 'rb') as f:
    my_list2 = pickle.load(f)
data2.append(my_list2)
with open('ZDT2 SMS2 Convergence GM.txt', 'rb') as f:
    my_list3 = pickle.load(f)
...
datax = []
data3=[]
with open('ZDT3 NSGA2 Convergence GM.txt', 'rb') as f:
    my_list1 = pickle.load(f)
data3.append(my_list1)
with open('ZDT3 SPEA2 Convergence GM.txt', 'rb') as f:
    my_list2 = pickle.load(f)
data3.append(my_list2)
with open('ZDT3 SMS2 Convergence GM.txt', 'rb') as f:
    my_list3 = pickle.load(f)
...
datax = []
data4=[]
with open('ZDT4 NSGA2 Convergence GM.txt', 'rb') as f:
    my_list1 = pickle.load(f)
data4.append(my_list1)
with open('ZDT4 SPEA2 Convergence GM.txt', 'rb') as f:
    my_list2 = pickle.load(f)
data4.append(my_list2)
with open('ZDT4 SMS2 Convergence GM.txt', 'rb') as f:
    my_list3 = pickle.load(f)
...
datax = []
data6=[]
with open('ZDT6 NSGA2 Convergence GM.txt', 'rb') as f:
    my_list1 = pickle.load(f)
data6.append(my_list1)
with open('ZDT6 SPEA2 Convergence GM.txt', 'rb') as f:
    my_list2 = pickle.load(f)
data6.append(my_list2)
with open('ZDT6 SMS2 Convergence GM.txt', 'rb') as f:
    my_list3 = pickle.load(f)
...
datax = []
data1=[]
with open('DTLZ1 NSGA2 Convergence GM.txt', 'rb') as f:
    my_list1 = pickle.load(f)
data1.append(my_list1)
with open('DTLZ1 SPEA2 Convergence GM.txt', 'rb') as f:
    my_list2 = pickle.load(f)
data1.append(my_list2)
with open('DTLZ1 SMS2 Convergence GM.txt', 'rb') as f:
    my_list3 = pickle.load(f)
data1.append(my_list3)
...
datax = []
data2=[]
with open('DTLZ2 NSGA2 Convergence GM.txt', 'rb') as f:
    my_list1 = pickle.load(f)
data2.append(my_list1)
with open('DTLZ2 SPEA2 Convergence GM.txt', 'rb') as f:
    my_list2 = pickle.load(f)
data2.append(my_list2)
with open('DTLZ2 SMS2 Convergence GM.txt', 'rb') as f:
    my_list3 = pickle.load(f)
data2.append(my_list3)
...
datax = []
data3=[]
with open('DTLZ3 NSGA2 Convergence GM.txt', 'rb') as f:
    my_list1 = pickle.load(f)
data3.append(my_list1)
with open('DTLZ3 SPEA2 Convergence GM.txt', 'rb') as f:
    my_list2 = pickle.load(f)
data3.append(my_list2)
with open('DTLZ3 SMS2 Convergence GM.txt', 'rb') as f:
    my_list3 = pickle.load(f)
data3.append(my_list3)
...
datax = []
data4=[]
with open('DTLZ4 NSGA2 Convergence GM.txt', 'rb') as f:
    my_list1 = pickle.load(f)
data4.append(my_list1)
with open('DTLZ4 SPEA2 Convergence GM.txt', 'rb') as f:
    my_list2 = pickle.load(f)
data4.append(my_list2)
with open('DTLZ4 SMS2 Convergence GM.txt', 'rb') as f:
    my_list3 = pickle.load(f)
data4.append(my_list3)
...
# datax = []
# data5=[]
# with open('DTLZ5 NSGA2 Convergence GM.txt', 'rb') as f:
#     my_list1 = pickle.load(f)
# data5.append(my_list1)
# with open('DTLZ5 SPEA2 Convergence GM.txt', 'rb') as f:
#     my_list2 = pickle.load(f)
# data5.append(my_list2)
# with open('DTLZ5 SMS2 Convergence GM.txt', 'rb') as f:
#     my_list3 = pickle.load(f)
...
# datax = []
# data6=[]
# with open('DTLZ6 NSGA2 Convergence GM.txt', 'rb') as f:
#     my_list1 = pickle.load(f)
# data6.append(my_list1)
# with open('DTLZ6 SPEA2 Convergence GM.txt', 'rb') as f:
#     my_list2 = pickle.load(f)
# data6.append(my_list2)
# with open('DTLZ6 SMS2 Convergence GM.txt', 'rb') as f:
#     my_list3 = pickle.load(f)
# data6.append(my_list3)
#
# media1a = np.mean(my_list1)
...
# datax = []
# data7=[]
# with open('DTLZ7 NSGA2 Convergence GM.txt', 'rb') as f:
#     my_list1 = pickle.load(f)
# data7.append(my_list1)
# with open('DTLZ7 SPEA2 Convergence GM.txt', 'rb') as f:
#     my_list2 = pickle.load(f)
# data7.append(my_list2)
# with open('DTLZ7 SMS2 Convergence GM.txt', 'rb') as f:
#     my_list3 = pickle.load(f)
...
ax.set_xticklabels([' ', 'DTLZ1', 'DTLZ2', 'DTLZ3', 'DTLZ4', ' '])
ax.set_xticks([0.5, 2.5, 6.0, 9.5, 13.0, 14.5])
#ax.set_xticklabels([' ', 'ZDT1', 'ZDT2', 'ZDT3', 'ZDT4', 'ZDT6', 'DTLZ1', 'DTLZ2', 'DTLZ3', 'DTLZ4', 'DTLZ5', 'DTLZ6', 'DTLZ7', ' '])
#ax.set_xticks([0.5, 1.5, 4.5, 7.5, 10.5, 13.5,16.5, 19.5, 22.5, 25.5, 28.5, 31.5, 34.5 ,  35.5, ])
