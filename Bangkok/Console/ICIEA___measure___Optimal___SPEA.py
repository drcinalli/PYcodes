...
if __name__=='__main__':
    ...
    for loop in range (0, NTEST):
        ...
        #update best front with hypervolume
    ...
    #optimalpareto is the Pareto Optimal Front
    #best_pareto_hypervolume is the best front achieved isolated
    #save Paretos
    my_world.WriteFileSolution(optimalpareto,0)
    my_world.WriteFileSolution(best_pareto_hypervolume,1)
