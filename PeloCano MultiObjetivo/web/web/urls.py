...
urlpatterns = [
    ...
    url(r'^service/ready_to_get_rank/(?P<resource_id>\d+)[/]?$', views.ReadyToGetRankView.as_view(), name='ready_to_get_rank'),
    url(r'^service/ready_to_get_rank[/]?$', views.ReadyToGetRankView.as_view(), name='ready_to_get_rank'),
    ...
    url(r'^service/get_partialrank/(?P<username>.+)[/]?$', views.GetPartialRankView.as_view(), name='get_partialrank'),
    url(r'^service/get_partialrank[/]?$', views.GetPartialRankView.as_view(), name='get_partialrank'),

    url(r'^service/get_topplayers/(?P<num>.+)[/]?$', views.GetTopPlayersView.as_view(), name='get_topplayers'),
    url(r'^service/get_topplayers[/]?$', views.GetTopPlayersView.as_view(), name='get_topplayers'),
    ...
    url(r'^service/get_online/(?P<username>.+)[/]?$', views.GetOnlinePlayersView.as_view(), name='get_online'),
    url(r'^service/get_online[/]?$', views.GetOnlinePlayersView.as_view(), name='get_online'),
